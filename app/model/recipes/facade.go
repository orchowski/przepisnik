...
import (
	...
	storage "fit.synapse/przepisnik/storage/recipes"
...
type recipes struct {
	recipeStorage RecipesStorage
}

func InitializeRecipesModule(basePath string) Facade {
	return &recipes{
		recipeStorage: storage.NewRecipesPersistentStorage(basePath),
	}
}
